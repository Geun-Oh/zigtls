...
run_cmd "bash -n scripts/release/check_task_closure_matrix.sh"
run_cmd "bash scripts/release/check_task_closure_matrix.sh --self-test"
run_cmd "bash scripts/release/check_task_closure_matrix.sh"
run_cmd "bash -n scripts/release/check_write_ahead_log.sh"
run_cmd "bash scripts/release/check_write_ahead_log.sh --self-test"
...
run_cmd "bash -n scripts/release/check_external_consumer_url.sh"
run_cmd "bash scripts/release/check_external_consumer_url.sh --self-test"
run_cmd "bash -n scripts/release/prepare_tag_release.sh"
run_cmd "bash scripts/release/prepare_tag_release.sh --self-test"
run_cmd "bash -n scripts/release/sync_latest_evidence_refs.sh"
run_cmd "bash scripts/release/sync_latest_evidence_refs.sh --self-test"
